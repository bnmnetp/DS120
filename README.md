...
* [Podcast | Machine Bias with Jeff Larson — Data Stories — Overcast](https://overcast.fm/+DLMVIbrQ)
...
* Make an adjacency matrix using cosine similarity of the Iris data set.  
* We'll look at a graph of this data in class.
